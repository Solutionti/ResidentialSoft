      ...
      <section>
        <div class="card testimonial-card">
            ...
            <div class="card-body px-3 py-4">
              ...
              <p class="text-auto text-uppercase">cr 26 # 67 - 30</p>
...
<div class="card-body px-lg-5 pt-0">
    <div class="text-center">
        <div class="form-row">
            <div class="col">
                <div class="md-form">
                    <input type="text" id="name"  class="form-control" value="Conjunto residencial" readonly>
                    <label>Nombre</label>
                </div>
            </div>
            <div class="col">
                <div class="md-form">
                    <input type="email" id="lastname" class="form-control" value="altagracia" readonly>
        ...
        <div class="form-row">
            <div class="col">
                <div class="md-form">
                    <input type="email" id="email" class="form-control" value="Altagracia@hotmail.com">
                    <label >Correo</label>
                </div>
            </div>
            <div class="col">
                <div class="md-form">
                    <input type="number" id="phone" class="form-control" value="3203304157">
        ...
        <div class="form-row">
            <div class="col">
                <div class="md-form">
                    <input type="text" id="address" class="form-control" value="cr 26 # 67 - 30">
